...
import { EntityArrayResponseType, EmergencyStationsDbService } from '../service/emergency-stations-db.service';
...
@Component({
  ...
  templateUrl: './emergency-stations-db.component.html',
})
export class EmergencyStationsDbComponent implements OnInit {
