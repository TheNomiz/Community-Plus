...
import { sampleWithRequiredData, sampleWithNewData } from '../emergency-stations.test-samples';

import { EmergencyStationsFormService } from './emergency-stations-form.service';

describe('EmergencyStations Form Service', () => {
  let service: EmergencyStationsFormService;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    service = TestBed.inject(EmergencyStationsFormService);
  });
