...
import { EmergencyStationsComponent } from './emergency-stations.component';
import SpyInstance = jest.SpyInstance;

describe('EmergencyStations Management Component', () => {
  let comp: EmergencyStationsComponent;
  let fixture: ComponentFixture<EmergencyStationsComponent>;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'emergency-stations', component: EmergencyStationsComponent }]),
        HttpClientTestingModule,
      ],
      declarations: [EmergencyStationsComponent],
      providers: [
        {
      ...
      .overrideTemplate(EmergencyStationsComponent, '')
      .compileComponents();

    fixture = TestBed.createComponent(EmergencyStationsComponent);
