...
export class LostFoundComponent implements OnInit {
  ...
  delete(lostFound: ILostFound): void {
    const modalRef = this.modalService.open(LostFoundDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.lostFound = lostFound;
