...
class UserProfileResourceIT {
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.username(UPDATED_USERNAME).name(UPDATED_NAME).password(UPDATED_PASSWORD).occupation(UPDATED_OCCUPATION);
    ...
    void partialUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.name(UPDATED_NAME).password(UPDATED_PASSWORD);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.username(UPDATED_USERNAME).name(UPDATED_NAME).password(UPDATED_PASSWORD).occupation(UPDATED_OCCUPATION);
